...
TURING_FOLDER  = turing/Action_to_string.ml print/P_transitions.ml print/Intro.ml turing/String_to_char_list.ml turing/Get_tape.ml print/P_transition.ml print/Tape.ml turing/Get_next_transition.ml turing/Get_letter_to_write.ml turing/Get_pos.ml turing/Get_letters.ml turing/Init_tape.ml turing/Launch_tape.ml
